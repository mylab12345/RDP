# PyInstaller spec for KB-Remote (Linux).
...
# builds when the builder environment has it, but keep the minimal-Linux
# build independent of that optional Qt extension.
native_datas = []
native_binaries = []
