...
; Brace-free stable ID (a GUID in braces would need brace-escaping that
; varies between Inno revisions; a unique constant string is accepted and
; keeps upgrade/uninstall identity stable).
#define MyAppId "KB-Remote-A531FAD6-A0F9-469C-BF5B-769BA62B4969"
