        ...
        self._items.extend(
            [
                ...
                PaletteItem(
                    ...
                    subtitle=f"Current: {ctx.settings.theme}",
                    action=lambda: (main._toggle_theme(ctx.settings.theme != "dark"), self.accept()),
                    icon_name="gear",
                ),
                PaletteItem(
                    category="Actions",
                    title="Settings…",
                    subtitle="Preferences, terminal fonts, theme, and security",
